...
export function defineAnimateBlocks() {
  ...
  Blockly.Blocks['rotate_to_object'] = {
    init: function () {
      this.jsonInit({
        type: 'rotate_to_object',
        message0: translate('rotate_to_object'),
        args0: [
          {
            type: 'field_variable',
            name: 'MODEL1',
          ...
          },
          {
            type: 'field_dropdown',
            name: 'ROTATE_MODE',
            options: [getDropdownOption('TOWARDS'), getDropdownOption('SAME_ROTATION')],
          },
          {
            type: 'field_variable',
            name: 'MODEL2',
        ...
        nextStatement: null,
        colour: categoryColours['Animate'],
        tooltip: getTooltip('rotate_to_object'),
      });
      this.setHelpUrl(getHelpUrlFor(this.type));
      this.setStyle('animate_blocks');
    },
