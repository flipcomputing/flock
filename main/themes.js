...
function getThemeBaseStyles(themeName) {
        const themes = {
                ...
                contrast: {
                        ...
                        events: { colourPrimary: "#734a4e" },
                        scene: { colourPrimary: "#0d5c00" },
                        transform: { colourPrimary: "#343ddb" },
                        animate: { colourPrimary: "#a71c4e" },
                        materials: { colourPrimary: "#7211b6" },
                        sound: { colourPrimary: "#ab0046" },
                        sensing: { colourPrimary: "#4e5a00" },
                        snippets: { colourPrimary: "#1c457f" },
                        control: { colourPrimary: "#970097" },
                        logic: { colourPrimary: "#0000ff" },
