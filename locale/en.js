export default {
  ...
  dispose_tooltip: 'Remove the specified object from the scene.\nKeyword: dispose',
  clone_mesh_tooltip: 'Clone an object and assign it to a variable.\nKeyword: clone',
  ...
  rotate_anim_seconds_tooltip:
    'Rotate an object to specified angles over a duration with options for reverse, looping, and easing.',
  animate_property_tooltip: 'Animate a material property of the object and its children.',
  ...
  stop_follow_tooltip: 'Stop the specified object from following another.\nKeyword: stopfollow',
  hold_tooltip:
  ...
  clear_effects_tooltip: 'Clear visual effects from selected object.\nKeyword: clear',
  ...
  play_tune_tooltip:
    'Import an ABC notation string to generate a tune with notes and repeats.\nKeyword: playtune',
  ...
  subtitle_tooltip:
    'Show text as an on-screen subtitle. 0 seconds stays until replaced.\nKeyword: subtitle',
  ...
  demo_heading_ui: 'Demos',
  close_demos_ui: 'Close demos',
  examples_cat_start_ui: 'Start',
  examples_cat_games_ui: 'Games',
  ...
  keyboard_navigation_ui: 'Browser navigation bar (overridden shortcuts work from here)',
  ...
  context_expand_option: 'Expand',
  context_collapse_all_option: 'Collapse all',
  ...
  physics_out_of_memory_log: 'Havok physics aborted, likely due to running out of memory.',
  ...
  shortcut_undo: 'Undo',
  shortcut_redo: 'Redo',
  shortcut_browser_nav: 'Browser navigation bar (overridden shortcuts work from here)',
  ...
  DELETE_UNDO_HINT: 'Use the undo button to restore deleted blocks.',
};
