export default {
  ...
  change_material_tooltip: 'Apply a selected material with a color tint to the specified object.',
  ...
  meshes_touching_tooltip: 'Return true if the two selected objects are touching.',
  time_tooltip:
  ...
  play_theme_tooltip: 'Play a theme tune on an object with adjustable speed, volume, and mode.',
  play_sound_tooltip:
  ...
  set_music_speed_tooltip: 'Set the music playback speed multiplier for an object.',
  ...
  move_by_xyz_single_tooltip: 'Move an object a given amount in either x y or z direction.',
  move_to_xyz_tooltip: 'Teleport the object to the coordinates. Optionally, use the Y axis.',
  move_to_xyz_single_tooltip: 'Teleport the object to the specified single coordinate.',
  move_to_tooltip: 'Teleport the first object to the location of the second object.',
  ...
  play_rumble_pattern_tooltip: 'Play a preset haptic rumble pattern on all connected controllers.',
  ...
  gizmo_hints_option_ui: 'Gizmo hints',
  ...
  close_projects_ui: 'Close projects',
  ...
  block_search_prompt: 'type to find a block',
  block_search_placeholder: 'Type to find a block',
  block_search_label: 'Find a block',
  block_search_result: 'block found',
  block_search_results: 'blocks found',
  block_search_tooltip: 'Type to find a block, then press Enter to add it.',
  ...
  fly_camera_instructions: 'Look around with arrow keys and Pg Up/Pg Down or Fn + ↑ ↓',
  ...
  // Help panel — title, and the suffix read out after every external link
  help_panel_title: 'Help',
  link_opens_in_new_tab: 'opens in a new tab',

  // How to panel — title, card names and back button
  howto_panel_title: 'How to',
  howto_add_sky_and_ground_ui: 'Add a sky and ground',
  howto_add_objects_ui: 'Add an object',
  howto_select_an_object_ui: 'Select an object',
  howto_position_objects_ui: 'Position an object',
  howto_position_with_code_ui: 'Position an object with code',
  howto_duplicate_objects_ui: 'Duplicate an object',
  howto_look_around_ui: 'Explore your world',
  howto_fly_camera_ui: 'Use the fly camera',
  howto_design_a_character_ui: 'Design a character',
  howto_walk_around_ui: 'Walk around',
  howto_colour_an_object_ui: 'Color an object',
  howto_rotate_an_object_ui: 'Rotate an object',
  howto_resize_an_object_ui: 'Resize an object',
  howto_delete_an_object_ui: 'Delete an object',
  howto_view_an_object_ui: 'View an object',
  howto_back_to_list: '← Back to How to',
  howto_filter_label_ui: 'Filter how-tos by topic',
  howto_filter_all_ui: 'All',
  howto_tag_gizmo_ui: 'Gizmo',
  howto_tag_scene_ui: 'Scene',
  howto_tag_character_ui: 'Character',
  howto_tag_camera_ui: 'Camera',
  howto_tag_code_ui: 'Code',
  ...
  player_action_camera_up: 'Camera up / Button 1',
  player_action_interact: 'Interact / Button 2',
  player_action_camera_down: 'Camera down / Button 3',
  player_action_spare: 'General action / Button 4',
  ...
  shortcut_toggle_block_toolbar: 'Show/hide block menu',
