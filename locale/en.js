export default {
  ...
  animate_property_tooltip:
    "Animate a material property of the mesh and its children.",
  ...
  change_material_tooltip:
    "Apply a selected material with a color tint to the specified mesh.\nKeyword: material",
  ...
  clear_effects_tooltip:
    "Clear visual effects from selected mesh.\nKeyword: clear",
  ...
  create_particle_effect_tooltip:
    "Create a particle effect attached to a mesh with configurable shape, gravity, size, color, transparency, lifetime, force, and rotation.",
  ...
  move_by_xyz_single_tooltip:
    "Move a mesh a given amount in either x y or z direction.\nKeyword: move",
  move_to_xyz_tooltip:
    "Teleport the mesh to the coordinates. Optionally, use the Y axis.\nKeyword: moveby",
  move_to_xyz_single_tooltip:
    "Teleport the mesh to the specified single coordinate.\nKeyword: moveby",
  move_to_tooltip:
  ...
  model_display_tree4: "Tree 4",
  model_display_hut: "Hut",
  model_display_hut2: "Hut 2",
  model_display_hut3: "Hut 3",
  model_display_hut4: "Hut 4",
  model_display_rocks: "Rocks",
  model_display_rocks2: "Rocks 2",
  model_display_rocks3: "Rocks 3",
  model_display_rocks4: "Rocks 4",
  model_display_pond: "Pond",
  model_display_boat: "Boat",
  model_display_airplane: "Airplane",
  model_display_airplane2: "Airplane 2",
  model_display_skateboard: "Skateboard",
  model_display_humped: "Humped",
  model_display_jetty: "Jetty",
  model_display_flower: "Flower",
  model_display_flower2: "Flower 2",
  model_display_star: "Star",
  model_display_heart: "Heart",
  model_display_coin: "Coin",
  model_display_egg: "Egg",
  model_display_gem1: "Gem 1",
  model_display_gem2: "Gem 2",
  model_display_gem3: "Gem 3",
