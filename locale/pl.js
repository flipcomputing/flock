export default {
  ...
  xyz_keyframe: 'w %1 %5 x: %2, y: %3, z: %4',
  animate_keyframes:
  ...
  move_to_xyz: 'ustaw pozycję %1 na %6 x: %2, y: %3, z: %4 y? %5',
  ...
  animate_property_tooltip: 'Animuj właściwość materiału obiektu i jego dzieci.',
  ...
  projects_ui: 'Projekty',
  new_ui: 'Nowy',
  starter_ui: 'Witaj',
  controller_starter_ui: 'Controller Starter',
  snow_globe_ui: 'Kula śnieżna',
  ...
  low_color_theme_ui: 'Mało koloru', // ai
  ...
  close_projects_ui: 'Zamknij projekty', // ai
  ...
  keyboard_navigation_ui: 'Pasek nawigacji przeglądarki (skróty działają tutaj)',
  ...
  context_expand_option: 'Rozwiń',
  context_collapse_all_option: 'Zwiń wszystko',
  ...
  drop_unsupported_file_alert: 'Można upuszczać tylko pliki .flock, .json, .fsnip lub .png.',

  // UI status messages
  max_mesh_limit_reached: '⚠️ Osiągnięto limit: możesz mieć tylko {max} obiektów w swoim świecie.',
  ...
  link_opens_in_new_tab: 'otwiera się w nowej karcie',
  ...
  shortcut_redo: 'Ponów',
  shortcut_browser_nav: 'Pasek adresu przeglądarki (zablokowane skróty działają stąd)',
  ...
  KEYBOARD_NAV_BLOCK_NAVIGATION_HINT:
    'Użyj klawisza strzałki w prawo, aby nawigować wewnątrz bloków', // machine
  KEYBOARD_NAV_CONSTRAINED_MOVE_HINT:
    'Użyj klawiszy strzałek do przesuwania, następnie %1 aby zaakceptować pozycję', // machine
  KEYBOARD_NAV_UNCONSTRAINED_MOVE_HINT:
    'Przytrzymaj %1 i użyj klawiszy strzałek do swobodnego przesuwania, następnie %2 aby zaakceptować', // machine
