export default {
  ...
  rotate_anim: 'rotera %1 till x %2 y %3 z %4 på %5 ms\n%6 omvänd? %7 loop? %8  %9',
  rotate_anim_seconds: 'rotera %1 till x %2 y %3 z %4 på %5 sekunder\n%6 omvänd? %7 loop? %8  %9',
  ...
  text_material: 'material %1 text %2 färg %3 bakgrund %4\nbredd: %5 höjd: %6 storlek: %7',
  ...
  low_vision_theme_ui: 'Lite färg', // ai
  ...
  keyboard_navigation_ui: 'Webbläsarens adressfält (överskrivna genvägar fungerar härifrån)',
  ...
  context_expand_option: 'Expandera',
  context_collapse_all_option: 'Fäll ihop alla',
  ...
  invalid_filetype_alert: 'Endast .json- eller .flock-projektfiler är tillåtna.',
  ...
  drop_unsupported_file_alert: 'Endast .flock-, .json-, .fsnip- eller .png-filer kan släppas.',

  // UI status messages
  max_mesh_limit_reached: '⚠️ Gräns nådd: du kan bara ha {max} objekt i din värld.',
  high_memory_usage_warning: 'Varning: hög minnesanvändning ({percent}%)',
  physics_out_of_memory_log: 'Havok-fysiken avbröts, troligen på grund av minnesbrist.', // AI-generated; needs validation
  ...
  shortcut_browser_nav: 'Webbläsarens adressfält (blockerade genvägar fungerar härifrån)',
  ...
  KEYBOARD_NAV_CONSTRAINED_MOVE_HINT:
    'Använd piltangenterna för att flytta, sedan %1 för att acceptera positionen', // machine
  KEYBOARD_NAV_UNCONSTRAINED_MOVE_HINT:
    'Håll inne %1 och använd piltangenterna för att flytta fritt, sedan %2 för att acceptera', // machine
