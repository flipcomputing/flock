...
export function registerMaterialGenerators(javascriptGenerator) {
  ...
  javascriptGenerator.forBlock['colour_from_string'] = function (block) {
    ...
    const colourValue = isBareHex ? `#${rawColourValue}` : rawColourValue || '#000000';
  ...
  javascriptGenerator.forBlock['set_material'] = function (block) {
    ...
    const material =
      javascriptGenerator.valueToCode(block, 'MATERIAL', javascriptGenerator.ORDER_ATOMIC) || '{}';
  ...
  javascriptGenerator.forBlock['material'] = function (block) {
    const baseColor =
      javascriptGenerator.valueToCode(block, 'BASE_COLOR', javascriptGenerator.ORDER_ATOMIC) ||
      '"#ffffff"';
