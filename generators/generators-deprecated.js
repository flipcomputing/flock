...
export function registerDeprecatedGenerators(javascriptGenerator) {
  ...
  javascriptGenerator.forBlock['controller_rumble'] = function (block) {
    ...
    const strength =
      javascriptGenerator.valueToCode(block, 'STRENGTH', javascriptGenerator.ORDER_NONE) || '1';
    const duration =
  ...
  javascriptGenerator.forBlock['controller_rumble_pattern'] = function (block) {
    ...
    const strength =
      javascriptGenerator.valueToCode(block, 'STRENGTH', javascriptGenerator.ORDER_NONE) || '1';
    const onDuration =
      javascriptGenerator.valueToCode(block, 'ON_DURATION', javascriptGenerator.ORDER_NONE) ||
      '200';
    const offDuration =
      javascriptGenerator.valueToCode(block, 'OFF_DURATION', javascriptGenerator.ORDER_NONE) ||
      '100';
    const repeats =
  ...
  javascriptGenerator.forBlock['create_custom_map'] = function (block) {
    ...
    for (let i = 1; i <= 25; i++) {
      const color =
        javascriptGenerator.valueToCode(block, `COLOR_${i}`, javascriptGenerator.ORDER_ATOMIC) ||
        '#808080';
      colors.push(color);
    }
  ...
  javascriptGenerator.forBlock['glide_to'] = function (block) {
    ...
    const duration =
      javascriptGenerator.valueToCode(block, 'DURATION', javascriptGenerator.ORDER_ATOMIC) ||
      '1000';
  ...
  javascriptGenerator.forBlock['controls_doWhile'] = function (block) {
    const condition =
      javascriptGenerator.valueToCode(block, 'BOOL', javascriptGenerator.ORDER_NONE) || 'false';
  ...
  javascriptGenerator.forBlock['hold'] = function (block) {
    ...
    const xOffset =
      javascriptGenerator.valueToCode(block, 'X_OFFSET', javascriptGenerator.ORDER_ATOMIC) || '0';
    const yOffset =
      javascriptGenerator.valueToCode(block, 'Y_OFFSET', javascriptGenerator.ORDER_ATOMIC) || '0';
    const zOffset =
