...
export function runMicrobitFieldTests() {
  describe('micro:bit image field helpers @microbit', function () {
    ...
    it('normalises field values like the wire format', function () {
      ...
      expect(normaliseImagePattern('#.#' + '9'.repeat(22))).to.equal('000' + '9'.repeat(22));
      expect(normaliseImagePattern({})).to.equal(normaliseImagePattern(String({})));
    });
    ...
    it('presets are valid patterns', function () {
      ...
      //   . # # # .
      //   # . # . #
      expect(MICROBIT_IMAGE_PRESETS.sun).to.equal('9090909990999990999090909');
