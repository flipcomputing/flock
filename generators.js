...
export function defineGenerators() {
        ...
        javascriptGenerator.forBlock["colour_rgb"] = function(block) {
                const red = javascriptGenerator.valueToCode(block, 'RED', javascriptGenerator.ORDER_NONE) || '0';
                const green = javascriptGenerator.valueToCode(block, 'GREEN', javascriptGenerator.ORDER_NONE) || '0';
                const blue = javascriptGenerator.valueToCode(block, 'BLUE', javascriptGenerator.ORDER_NONE) || '0';
        ...
        javascriptGenerator.forBlock["colour_blend"] = function(block) {
                const colour1 = javascriptGenerator.valueToCode(block, 'COLOUR1', javascriptGenerator.ORDER_NONE) || '"#000000"';
                const colour2 = javascriptGenerator.valueToCode(block, 'COLOUR2', javascriptGenerator.ORDER_NONE) || '"#ffffff"';
                const ratio = javascriptGenerator.valueToCode(block, 'RATIO', javascriptGenerator.ORDER_NONE) || '0.5';
